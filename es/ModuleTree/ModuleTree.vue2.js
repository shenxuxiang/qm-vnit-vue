...
var script = /*#__PURE__*/defineComponent(_objectSpread(_objectSpread({}, {
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      return openBlock(), createElementBlock("div", null, [_ctx.showFilter ? (openBlock(), createBlock(unref(Input).Search, {
        key: 0,
      ...
      }, null, 8 /* PROPS */, ["value", "placeholder"])) : createCommentVNode("v-if", true), createElementVNode("div", {
