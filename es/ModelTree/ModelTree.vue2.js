...
var script = /*#__PURE__*/ defineComponent({
    ...
    setup(__props, { expose: __expose, emit }) {
        ...
        const treeData = computed(() => typeof props.computedTreeData === 'function' ? props.computedTreeData(props.treeData) : props.treeData);
        // 扁平的 TreeDate
        const flatTreeData = computed(() => computedFlatTreeData(treeData.value));
        // 筛选后的 TreeData
        const filteredTreeData = computed(() => searchValue.value ? filterTreeData(treeData.value, searchValue.value) : treeData.value);
