...
var script = /*#__PURE__*/defineComponent({
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      })])], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */)) : createCommentVNode("v-if", true), createCommentVNode(" 可操作区域 "), createElementVNode("div", _hoisted_4, [createCommentVNode(" 删除按钮 "), createVNode(unref(DeleteOutlined), {
        "class": "qm-vnit-upload-image-item-remove-icon",
        onClick: _cache[0] || (_cache[0] = function ($event) {
          return handleRemove(_ctx.uid);
        })
      }), createCommentVNode(" 预览按钮 "), _ctx.status === 'done' ? (openBlock(), createBlock(unref(EyeOutlined), {
        key: 0,
