  ...
  setup: function setup(__props, _ref) {
    ...
    function getTableList() {
      ...
      if ((_props$beforeQueryAct = (_props$beforeQueryAct2 = props.beforeQueryAction) === null || _props$beforeQueryAct2 === void 0 ? void 0 : _props$beforeQueryAct2.call(props, params)) !== null && _props$beforeQueryAct !== void 0 ? _props$beforeQueryAct : true) {
        ...
        props.queryTableList(params).then(function (res) {
          return _Object$assign(tableResource, props.customResponse(res.data));
        })["finally"](function () {
    ...
    function handleExport(values) {
      ...
      props === null || props === void 0 || (_props$exportTableLis = props.exportTableList) === null || _props$exportTableLis === void 0 || (_props$exportTableLis = _props$exportTableLis.call(props, values)) === null || _props$exportTableLis === void 0 || _props$exportTableLis.then(function (res) {
        ...
        var fileName = res.fileName,
          data = res.data;
        downloadFile((_props$exportFileName = props === null || props === void 0 ? void 0 : props.exportFileName) !== null && _props$exportFileName !== void 0 ? _props$exportFileName : fileName, data);
      });
    }
    // 分页
    ...
    return function (_ctx, _cache) {
      return openBlock(), createElementBlock("section", {
        ...
        _: 3 /* FORWARDED */
      }, 8 /* PROPS */, ["cols", "showExport", "submitButtonText", "queryList"])) : createCommentVNode("v-if", true), createElementVNode("div", _hoisted_1, [createElementVNode("div", _hoisted_2, [_hoisted_3, renderSlot(_ctx.$slots, "extra")]), createVNode(unref(Table), mergeProps({
        bordered: ""
      }, _ctx.$attrs, {
        rowKey: _ctx.rowKey,
        scroll: _ctx.scroll,
        ...
        _: 3 /* FORWARDED */
      }, 16 /* FULL_PROPS */, ["rowKey", "scroll", "size", "loading", "rowSelection", "dataSource", "columns"]), createVNode(unref(Pagination), {
        pageSize: tableResource.pageSize,
