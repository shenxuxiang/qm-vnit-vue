  ...
  setup: function setup(__props, _ref) {
    ...
    __expose({
      ...
      getAllParentKeys: function getAllParentKeys() {
        var _context2;
        var keys = [];
        (0, _forEach["default"])(_context2 = localCheckedKeys.value).call(_context2, function (key) {
    ...
    return function (_ctx, _cache) {
      return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", null, [_ctx.showFilter ? ((0, _vue.openBlock)(), (0, _vue.createBlock)((0, _vue.unref)(_input["default"]).Search, {
        ...
        disabled: _ctx.disabled
      }), null, 16 /* FULL_PROPS */, ["checkedKeys", "expandedKeys", "selectedKeys", "treeData", "checkable", "disabled"])], 2 /* CLASS */)]);
    };
  }
}));