  ...
  setup: function setup(__props, _ref) {
    ...
    (0, _vue.onMounted)(function () {
      ...
      (0, _vue.watch)([function () {
        ...
        // navBar 长度
        var navBarWidth = navBarContainerRef.value.scrollWidth;
        ...
        if (nonSliding.value) {
          var _navBarContainerRef$v, _navBarContainerRef$v2;
          translateX = 0;
          navBarRef.value.style.cssText = "transform: translateX(0px)";
          (_navBarContainerRef$v = navBarContainerRef.value) === null || _navBarContainerRef$v === void 0 || _navBarContainerRef$v.classList.remove('qm-navbar-content-left-shadow');
          (_navBarContainerRef$v2 = navBarContainerRef.value) === null || _navBarContainerRef$v2 === void 0 || _navBarContainerRef$v2.classList.remove('qm-navbar-content-right-shadow');
        } else {
          if (translateX >= maximumOffsetDistance) {
            var _navBarContainerRef$v3, _navBarContainerRef$v4;
            translateX = maximumOffsetDistance;
            navBarRef.value.style.cssText = "transform: translateX(".concat(-maximumOffsetDistance, "px)");
            (_navBarContainerRef$v3 = navBarContainerRef.value) === null || _navBarContainerRef$v3 === void 0 || _navBarContainerRef$v3.classList.add('qm-navbar-content-left-shadow');
            (_navBarContainerRef$v4 = navBarContainerRef.value) === null || _navBarContainerRef$v4 === void 0 || _navBarContainerRef$v4.classList.remove('qm-navbar-content-right-shadow');
          } else if (translateX > 0) {
            updateNavBarPosition();
          } else {
            var _navBarContainerRef$v5, _navBarContainerRef$v6;
            (_navBarContainerRef$v5 = navBarContainerRef.value) === null || _navBarContainerRef$v5 === void 0 || _navBarContainerRef$v5.classList.remove('qm-navbar-content-left-shadow');
            (_navBarContainerRef$v6 = navBarContainerRef.value) === null || _navBarContainerRef$v6 === void 0 || _navBarContainerRef$v6.classList.add('qm-navbar-content-right-shadow');
          }
        }
      }, {
        immediate: true,
    ...
    function handleMouseEnterOthersIcon() {
      var navBarContainerWidth = navBarContainerRef.value.offsetWidth;
      var list = [];
      if (translateX <= 0) {
    ...
    function handleMouseWheel(event) {
      ...
      if (deltaY > 0) {
        ...
        if (distance >= maximumOffsetDistance) {
          var _navBarContainerRef$v7, _navBarContainerRef$v8;
          translateX = maximumOffsetDistance;
          navBarRef.value.style.cssText = "transform: translateX(".concat(-translateX, "px)");
          (_navBarContainerRef$v7 = navBarContainerRef.value) === null || _navBarContainerRef$v7 === void 0 || _navBarContainerRef$v7.classList.add('qm-navbar-content-left-shadow');
          (_navBarContainerRef$v8 = navBarContainerRef.value) === null || _navBarContainerRef$v8 === void 0 || _navBarContainerRef$v8.classList.remove('qm-navbar-content-right-shadow');
        } else {
          var _navBarContainerRef$v9, _navBarContainerRef$v10;
          translateX = distance;
          navBarRef.value.style.cssText = "transform: translateX(".concat(-translateX, "px)");
          (_navBarContainerRef$v9 = navBarContainerRef.value) === null || _navBarContainerRef$v9 === void 0 || _navBarContainerRef$v9.classList.add('qm-navbar-content-left-shadow');
          (_navBarContainerRef$v10 = navBarContainerRef.value) === null || _navBarContainerRef$v10 === void 0 || _navBarContainerRef$v10.classList.add('qm-navbar-content-right-shadow');
        }
      } else if (deltaY < 0) {
        ...
        if (distance <= 0) {
          ...
          translateX = 0;
          navBarRef.value.style.cssText = "transform: translateX(0px)";
          (_navBarContainerRef$v11 = navBarContainerRef.value) === null || _navBarContainerRef$v11 === void 0 || _navBarContainerRef$v11.classList.remove('qm-navbar-content-left-shadow');
          (_navBarContainerRef$v12 = navBarContainerRef.value) === null || _navBarContainerRef$v12 === void 0 || _navBarContainerRef$v12.classList.add('qm-navbar-content-right-shadow');
        } else {
    ...
    function updateNavBarPosition() {
      ...
      if (currentIndex > boundaryIndex) {
        ...
        if (x >= maximumOffsetDistance) {
          ...
          (_navBarContainerRef$v15 = navBarContainerRef.value) === null || _navBarContainerRef$v15 === void 0 || _navBarContainerRef$v15.classList.add('qm-navbar-content-left-shadow');
          (_navBarContainerRef$v16 = navBarContainerRef.value) === null || _navBarContainerRef$v16 === void 0 || _navBarContainerRef$v16.classList.remove('qm-navbar-content-right-shadow');
        } else {
        ...
        var _navBarContainerRef$v19, _navBarContainerRef$v20;
        translateX = 0;
        navBarRef.value.style.cssText = "transform: translateX(0px)";
        (_navBarContainerRef$v19 = navBarContainerRef.value) === null || _navBarContainerRef$v19 === void 0 || _navBarContainerRef$v19.classList.remove('qm-navbar-content-left-shadow');
        (_navBarContainerRef$v20 = navBarContainerRef.value) === null || _navBarContainerRef$v20 === void 0 || _navBarContainerRef$v20.classList.add('qm-navbar-content-right-shadow');
      }
    }
