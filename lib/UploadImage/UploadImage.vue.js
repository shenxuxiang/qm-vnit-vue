  ...
  setup: function setup(__props, _ref) {
      ...
      if (props.maxSize) {
        ...
        while (length--) {
          ...
          if (file.size > props.maxSize) {
            ...
            _message.warning(file.name + '文件过大无法上传！');
          }
        }
    ...
    return function (_ctx, _cache) {
      return openBlock(), createElementBlock(Fragment, null, [createElementVNode("div", _hoisted_1, [createElementVNode("ul", _hoisted_2, [(openBlock(true), createElementBlock(Fragment, null, renderList(_fileList.value, function (file) {
        ...
        ref: uploadButtonRef,
        "class": normalizeClass(['qm-vnit-upload-image-label', {
          disabled: _ctx.disabled
        }]),
        onClick: handleClick
      ...
      }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_5)], 2 /* CLASS */), [[vShow, !_ctx.maxCount || _fileList.value.length < _ctx.maxCount]])])]), !_ctx.previewFile ? (openBlock(), createBlock(Teleport, {
        key: 0,
        to: "body"
