...
var _hoisted_5 = ["accept", "disabled", "multiple"];
var script = exports["default"] = /*#__PURE__*/(0, _vue.defineComponent)(_objectSpread(_objectSpread({}, {
  ...
  setup: function setup(__props, _ref) {
    ...
    function handleFileChange(event) {
      ...
      if (props.maxCount) {
        var rest = props.maxCount - _fileList.value.length;
        rest < newFiles.length && _message2["default"].warning("\u6700\u591A\u53EA\u80FD\u4E0A\u4F20".concat(props.maxCount, "\u4E2A\u6587\u4EF6\uFF01"));
    ...
    return function (_ctx, _cache) {
      return (0, _vue.openBlock)(), (0, _vue.createElementBlock)(_vue.Fragment, null, [(0, _vue.createElementVNode)("div", _hoisted_1, [(0, _vue.createElementVNode)("ul", _hoisted_2, [((0, _vue.openBlock)(true), (0, _vue.createElementBlock)(_vue.Fragment, null, (0, _vue.renderList)(_fileList.value, function (file) {
        ...
        ref: uploadButtonRef,
        "class": (0, _vue.normalizeClass)(['qm-vnit-upload-image-label', {
          disabled: _ctx.disabled
        }]),
        onClick: handleClick
      ...
      }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_5)], 2 /* CLASS */), [[_vue.vShow, !_ctx.maxCount || _fileList.value.length < _ctx.maxCount]])])]), !_ctx.previewFile ? ((0, _vue.openBlock)(), (0, _vue.createBlock)(_vue.Teleport, {
        key: 0,
        to: "body"
