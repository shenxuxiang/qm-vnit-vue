  ...
  setup: function setup(__props, _ref) {
    ...
    function uploadFile() {
      if (props.uid && props.status === 'loading' && props.rawResource) {
        ...
        // 上传成功
        ajax.onSuccess( /*#__PURE__*/function () {
    ...
    function initialCanvas() {
      ...
      var ctx = cvsRef.value.getContext('2d');
      ctxRef.value = ctx;
      ctx.save();
      ctx.translate(42, 42);
    }
    ...
    function fadeInAnimation() {
      if (cvsRef.value) {
        ...
        (0, _setTimeout2["default"])(function () {
          var _cvsRef$value;
          if ((_cvsRef$value = cvsRef.value) !== null && _cvsRef$value !== void 0 && _cvsRef$value.parentNode) {
            // @ts-ignore
    ...
    return function (_ctx, _cache) {
      ...
      })])], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */)) : (0, _vue.createCommentVNode)("v-if", true), (0, _vue.createCommentVNode)(" 可操作区域 "), (0, _vue.createElementVNode)("div", _hoisted_4, [(0, _vue.createCommentVNode)(" 删除按钮 "), !_ctx.disabled ? ((0, _vue.openBlock)(), (0, _vue.createBlock)((0, _vue.unref)(_DeleteOutlined["default"]), {
        key: 0,
        "class": "qm-vnit-upload-image-item-remove-icon",
        onClick: _cache[0] || (_cache[0] = function ($event) {
          return handleRemove(_ctx.uid);
        })
      })) : (0, _vue.createCommentVNode)("v-if", true), (0, _vue.createCommentVNode)(" 预览按钮 "), _ctx.status === 'done' ? ((0, _vue.openBlock)(), (0, _vue.createBlock)((0, _vue.unref)(_EyeOutlined["default"]), {
        key: 1,
