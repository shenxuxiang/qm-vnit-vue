...
require("./Loading.vue.js");
require("./ToolBar.vue.js");
require("./Slider.vue.js");
require("../Icon/index.js");
require("./PreviewImage.css");
var _LoadingVue2 = _interopRequireDefault(require("./Loading.vue2.js"));
var _ToolBarVue2 = _interopRequireDefault(require("./ToolBar.vue2.js"));
require("../Icon/Icon.vue2.js");
var _IconVue2 = _interopRequireDefault(require("../Icon/Icon.vue.js"));
...
var script = exports["default"] = /*#__PURE__*/(0, _vue.defineComponent)(_objectSpread(_objectSpread({}, {
  ...
  setup: function setup(__props, _ref) {
    ...
    var _imgs = (0, _vue.computed)(function () {
      var _context;
      return (0, _map["default"])(_context = props.imgs).call(_context, function (item) {
        return item.url;
      });
    });
    var hdImgs = (0, _vue.computed)(function () {
      var _context2;
      return (0, _map["default"])(_context2 = props.imgs).call(_context2, function (item) {
        return item.hdUrl;
      });
    });
    var showLoading = (0, _vue.ref)(false);
    // 图片预加载器
    var imagePreloader = (0, _vue.ref)();
    var currentPreviewImageUrl = (0, _vue.ref)(_defaultImageSvg["default"]);
    // 当组件展示时，不让页面滚动。
    ...
    (0, _vue.watch)([hdImgs, indicator, function () {
      return props.open;
    }], function () {
      // 展示 lading，给用户一个反馈
      showLoading.value = true;
      currentPreviewImageUrl.value = _defaultImageSvg["default"];
    ...
    function handleShrink() {
      ...
      imgRef.value.style.cssText = (0, _concat["default"])(_context5 = (0, _concat["default"])(_context6 = "transform: scale(".concat(x, ", ")).call(_context6, y, ") rotate(")).call(_context5, rotate, "deg);");
    }
    // 放大
    function handleEnlarge() {
      ...
      imgRef.value.style.cssText = (0, _concat["default"])(_context7 = (0, _concat["default"])(_context8 = "transform: scale(".concat(scaleX * 1.25, ", ")).call(_context8, scaleY * 1.25, ") rotate(")).call(_context7, rotate, "deg);");
    }
    ...
    return function (_ctx, _cache) {
      return (0, _vue.openBlock)(), (0, _vue.createBlock)(_vue.Transition, {
        ...
        "default": (0, _vue.withCtx)(function () {
          return [(0, _vue.withDirectives)((0, _vue.createElementVNode)("section", _hoisted_1, [(0, _vue.createVNode)(_LoadingVue2["default"], {
            size: "default",
            theme: "light",
            open: showLoading.value
          }, null, 8 /* PROPS */, ["open"]), (0, _vue.createCommentVNode)(" 图片预览部分 "), (0, _vue.createElementVNode)("div", {
            ref_key: "imgXRef",
            ref: imgXRef,
          ...
          }, [((0, _vue.openBlock)(), (0, _vue.createElementBlock)("img", {
            ref_key: "imgRef",
            ref: imgRef,
          ...
          }, null, 8 /* PROPS */, ["imageElement"]), _imgs.value.length > 1 ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", {
            key: 0,
          ...
          })], 2 /* CLASS */)) : (0, _vue.createCommentVNode)("v-if", true), _imgs.value.length > 1 ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", {
            key: 1,
          ...
          })], 2 /* CLASS */)) : (0, _vue.createCommentVNode)("v-if", true), (0, _vue.createCommentVNode)(" 顶部滑块 "), _imgs.value.length > 1 ? ((0, _vue.openBlock)(), (0, _vue.createBlock)(_SliderVue2["default"], {
            key: 2,
            open: _ctx.open,
            imgs: _imgs.value,
          ...
          }, null, 8 /* PROPS */, ["open", "imgs", "pageSize", "indicator"])) : (0, _vue.createCommentVNode)("v-if", true)], 512 /* NEED_PATCH */), [[_vue.vShow, _ctx.open]])];
        }),
        _: 1 /* STABLE */
      });
    };
