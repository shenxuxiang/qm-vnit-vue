...
var _hoisted_2 = /*#__PURE__*/(0, _vue.createElementVNode)("p", {
  style: {
    "margin-left": "16px"
  }
}, "查询表格", -1 /* HOISTED */);
var script = exports["default"] = /*#__PURE__*/(0, _vue.defineComponent)(_objectSpread(_objectSpread({}, {
  ...
  setup: function setup(__props, _ref2) {
    ...
    var contentHeaderRef = (0, _vue.shallowRef)();
    ...
    return function (_ctx, _cache) {
      return (0, _vue.openBlock)(), (0, _vue.createElementBlock)(_vue.Fragment, null, [(0, _vue.createCommentVNode)(" eslint-disable-next-line "), (0, _vue.createElementVNode)("section", {
        "class": (0, _vue.normalizeClass)(["qm-content-form-table", _ctx["class"]]),
        ...
        cols: _ctx.cols,
        "class": (0, _vue.normalizeClass)(_ctx.headerClass),
        style: (0, _vue.normalizeStyle)(_ctx.headerStyle),
        reset: handleReset,
        "export": handleExport,
        submit: handleSubmit,
        ...
        _: 3 /* FORWARDED */
      }, 8 /* PROPS */, ["cols", "class", "style", "showExport", "submitButtonText", "queryList"])) : (0, _vue.createCommentVNode)("v-if", true), (0, _vue.createElementVNode)("div", {
        "class": (0, _vue.normalizeClass)(["qm-content-form-table-body", _ctx.tableClass]),
        style: (0, _vue.normalizeStyle)(_ctx.tableStyle)
      }, [(0, _vue.createElementVNode)("div", _hoisted_1, [_hoisted_2, (0, _vue.renderSlot)(_ctx.$slots, "extra")]), (0, _vue.createVNode)((0, _vue.unref)(_table["default"]), (0, _vue.mergeProps)({
        bordered: ""
      }, _ctx.$attrs, {
        rowKey: _ctx.rowKey,
        scroll: _ctx.scroll,
      ...
      }, null, 8 /* PROPS */, ["size", "showTotal", "total", "current", "pageSize"])], 6 /* CLASS, STYLE */)], 6 /* CLASS, STYLE */)], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */);
    };
  }
}));