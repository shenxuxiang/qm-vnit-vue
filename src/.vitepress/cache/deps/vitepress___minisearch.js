  ...
  (function () {
        ...
        return __generator(this, function (_j) {
          switch (_j.label) {
            ...
            case 2:
              ...
              try {
                for (
                  fieldsData_1 = ((e_11 = void 0), __values(fieldsData)), fieldsData_1_1 = fieldsData_1.next();
                  !fieldsData_1_1.done;
                  ...
                  try {
                    for (
                      fieldIndex_1 = ((e_12 = void 0), __values(fieldIndex)), fieldIndex_1_1 = fieldIndex_1.next();
                      !fieldIndex_1_1.done;
    ...
    MiniSearch2.prototype.executeQuerySpec = function (query, searchOptions) {
      ...
      if (prefixMatches) {
        try {
          for (
            var prefixMatches_1 = __values(prefixMatches), prefixMatches_1_1 = prefixMatches_1.next();
    ...
    MiniSearch2.prototype.toJSON = function () {
      ...
      try {
        for (var _c = __values(this._index), _d = _c.next(); !_d.done; _d = _c.next()) {
          ...
          try {
            for (
              var fieldIndex_2 = ((e_22 = void 0), __values(fieldIndex)), fieldIndex_2_1 = fieldIndex_2.next();
              !fieldIndex_2_1.done;
    ...
    MiniSearch2.prototype.termResults = function (
      ...
      try {
        for (var _d = __values(Object.keys(fieldBoosts)), _e = _d.next(); !_e.done; _e = _d.next()) {
          ...
          try {
            for (
              var _f = ((e_24 = void 0), __values(fieldTermFreqs.keys())), _g = _f.next();
              !_g.done;
              _g = _f.next()
            ) {
              var docId = _g.value;
